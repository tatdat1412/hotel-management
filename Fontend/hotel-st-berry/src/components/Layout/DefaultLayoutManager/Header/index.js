...
function Header() {
    ...
    const [avatar, setAvatar] = useState('/admin/img/mng-avatar.png'); // Default avatar
    ...
    useEffect(() => {
        const fetchUser = async () => {
            try {
                ...
                if (response.data.role.name !== 'ROLE_MANAGER') {
                ...
                setAvatar(response.data.avatar || '/admin/img/mng-avatar.png');
                setIsLoggedIn(true);
            } catch (error) {
